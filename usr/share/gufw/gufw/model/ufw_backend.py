...
class Backend():
    ...
    def set_cfg_value(self, attr, value):
        ...
        if not os.path.isfile(cfg_file):
            ...
            cfg.write(f)  
            f.close()  
            os.chmod(cfg_file, 0600) # Just an admin can read this file
    ...
    def set_profile_values(self, profile, status, incoming, outgoing, routed, rules):
        ...
        cfg.write(f)  
        f.close()
        os.chmod(file_path, 0600) # Just an admin can read this file
    ...
    def export_profile(self, profile, dst):
        ...
        try:
            ...
            os.chmod(dst, 0600) # Avoid other users change a profile
        except:
            pass
    
    def refresh_log(self):
        f = file(self.GUFW_LOG, 'w')
        f.close()
